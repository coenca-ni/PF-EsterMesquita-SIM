...
% Gerar valores aleatórios para o campo field5
fieldX_completas = randi([0, 200], length(datas_completas), 1);  % Valores aleatórios entre 0 e 200
...
title('Dados Originais (Valores Aleatórios)');
xlabel('Data');
